...
_LOW_OPCODE_ROWS: Dict[int, Dict[str, Any]] = {0: {'confidence': 'exact',
 ...
 103: {'confidence': 'partial',
       'mnemonic': 'protected_runtime_block',
       'semantic': 'large SEH-protected nested runtime/parser block. The asm slice shows selector dispatch and many '
                   'cases, but not enough symbolic information to name every submode safely.',
       'subopcode': 103,
       'table_ea': 5635268,
       'target_ea': 4734064,
 ...
 117: {'confidence': 'external',
       'mnemonic': 'external_native_486A60',
       'semantic': 'dispatch table target is sub_486A60, but no chunk/body for 0x486A60 is present in the supplied asm '
                   'slice; semantics remain external',
       'subopcode': 117,
       'table_ea': 5635324,
       'target_ea': 4745824,
