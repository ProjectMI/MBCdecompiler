...
def test_normalizer_inlines_call_preparation_across_ascii(tmp_path: Path) -> None:
    knowledge = write_manual(tmp_path)
    ...
    words = [
        ...
        build_word(12, 0x66, 0x15, 0x4B10),  # stack_shuffle
...
def test_normalizer_attaches_cleanup_across_ascii(tmp_path: Path) -> None:
    knowledge = write_manual(tmp_path)

    words = [
        build_word(0, 0x01, 0xF0, 0x0000),  # stack_teardown_4
        build_ascii_word(4, "IJKL"),
